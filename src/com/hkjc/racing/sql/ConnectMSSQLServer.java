...
{
   public void insertData(String db_connect_string,
            String db_userid,
            String db_password, Race race)
   {
      try {
   ...
   public void insertJockeyData(String db_connect_string,
           String db_userid,
           String db_password, Jockey jockey)
  {
     try {
        Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
        Connection conn = DriverManager.getConnection(db_connect_string,
   ...
   public void insertHorseInfo(String db_connect_string,
           String db_userid,
           String db_password, RaceXMLParser race)
  {
     try {
        Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
        Connection conn = DriverManager.getConnection(db_connect_string,
        ...
        String queryString = "INSERT INTO [HKJC].[dbo].RaceHorse " + "VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
   ...
   public void insertRaceResults(String db_connect_string,
           String db_userid,
           String db_password, RaceResult race)
  {
     try {
        Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
        Connection conn = DriverManager.getConnection(db_connect_string,
   ...
   private void insertCompositeOddData(String db_connect_string,
           String db_userid,
           String db_password, CompositeOdd comOdd)
  {
     try {
        Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
        Connection conn = DriverManager.getConnection(db_connect_string,
   ...
   private void insertRaceCard(String db_connect_string,
           String db_userid,
           String db_password, RaceCard raceCard)
  {
     try {
        Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
        Connection conn = DriverManager.getConnection(db_connect_string,
        ...
        String queryString = "INSERT INTO [HKJC].[dbo].RaceCard " + "VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
   ...
   public boolean insertData(Race race){
	   ConnectMSSQLServer connServer = new ConnectMSSQLServer();
	   connServer.insertData("jdbc:sqlserver://localhost", "dpsduxb34",
			   "Srujana7890", race);
	   
	   return false;
   }
   
   public boolean insertCompositeOdds(CompositeOdd comOdd){
	   ConnectMSSQLServer connServer = new ConnectMSSQLServer();
	   connServer.insertCompositeOddData("jdbc:sqlserver://localhost", "dpsduxb34",
			   "Srujana7890", comOdd);
   ...
   public boolean insertRaceCard(RaceCard race) {
	   ConnectMSSQLServer connServer = new ConnectMSSQLServer();
	   connServer.insertRaceCard("jdbc:sqlserver://localhost", "dpsduxb34",
			   "Srujana7890", race);
   ...
   public boolean insertHorseInfoData(RaceXMLParser race) {
	   ConnectMSSQLServer connServer = new ConnectMSSQLServer();
	   connServer.insertHorseInfo("jdbc:sqlserver://localhost", "dpsduxb34",
			   "Srujana7890", race);
   ...
   public boolean insertJockeyInfoData(Jockey jockey) {
	   ConnectMSSQLServer connServer = new ConnectMSSQLServer();
	   connServer.insertJockeyData("jdbc:sqlserver://localhost", "dpsduxb34",
			   "Srujana7890", jockey);
   ...
   public boolean insertRaceResultData(RaceResult raceResult) {
	   ConnectMSSQLServer connServer = new ConnectMSSQLServer();
	   connServer.insertRaceResults("jdbc:sqlserver://localhost", "dpsduxb34",
			   "Srujana7890", raceResult);

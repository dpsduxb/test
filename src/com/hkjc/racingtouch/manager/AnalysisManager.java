...
public class AnalysisManager {
	...
	public List<Map<String, Object>> getRecordsByGroup(List<String> groupByCols){
		String queryString = "SELECT " + groupByCols.toString() + ", COUNT(*) as total FROM [HKJC].[dbo].RaceHorse GROUP BY " 
	...
	public List<Map<String, Object>> getResultDividendsByGroup(List<String> groupByCols){
		String queryString = "SELECT " + groupByCols.toString() + ", COUNT(position) as winTotal, COUNT(*) as total, "
				+ "(winTotal/total)*10*dividendAmount as winPercentage FROM [HKJC].[dbo].RaceHorse rh LEFT OUTER JOIN RaceResult rr "
